...
class AmazonView extends StatelessWidget {
   AmazonView({super.key});

  final List<String> carouselImages = const [
    'https://m.media-amazon.com/images/I/61cwywLZR-L._SX3000_.jpg',
                            ...
                            children: [
                              ...
                              if (product.isPrime)
                                const Padding(
                                  ...
                                  child: Icon(Icons.local_shipping, size: 16, color: Colors.blue),
                                ),
                            ],
                          ),
                        ),
...
//                   SizedBox(width: 8),
//                   Text(
//                     'Deliver to Manav - Porbander 360575',
